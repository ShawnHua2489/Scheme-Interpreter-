...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        if symbol in self.bindings:
            ...
            return self.parent.lookup(symbol) #RRR
        # END PROBLEM 3
    ...
    def make_child_frame(self, formals, vals):
        ...
        def helper(formal, val):
            if (formal is nil and val is not nil) or \
            (formal is not nil and val is nil):
                raise SchemeError('unmatching formals and vals')
            if formal is nil and val is nil:
                return 
...
class PrimitiveProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            return self.fn(*python_args) #RRR add([1,2,3])
        except TypeError:
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        return Frame.make_child_frame(self.env, self.formals, args) #self.env!!!!!!!
        #lambda_defined_frame should have been env
        # END PROBLEM 12
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        env.define(target, value) #???env.define? or current frame.define? 
        return target
        # END PROBLEM 6
        ...
        return target.first #RRR  不需要提前设置symbol = target.first 再return symbol 
...
def do_and_form(expressions, env):
    ...
    # BEGIN PROBLEM 13
    "*** YOUR CODE HERE ***"
    if expressions is nil: #RRR can also use iteration 
        return True
...
def do_cond_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if scheme_truep(test):
            ...
            #elif expressions.second is nil:
                #return None
            elif clause.second.second is not nil:
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        vals = Pair(scheme_eval(bindings.first.second.first, env), vals) #second.first已经好几次犯这个错了
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 16
    "*** YOUR CODE HERE ***"
    new_mu = MuProcedure(formals, expressions.second)  #why not expression.second.first???
    return  new_mu
